...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, 
                             ...
                             QGroupBox, QSplitter, QFrame, QSizePolicy, QLineEdit, QButtonGroup)
...
class UIComponents:
    ...
    def create_settings_frame(self, parent_layout: QVBoxLayout, charcombo: QComboBox) -> None:
        ...
        self.rb_manual.toggled.connect(lambda c: self.app.events.on_mode_change("manual") if c else None)
        self.rb_ocr.toggled.connect(lambda c: self.app.events.on_mode_change("ocr") if c else None)
        ...
        self.rb_batch.toggled.connect(lambda c: self.app.events.on_score_mode_change("batch") if c else None)
        self.rb_single.toggled.connect(lambda c: self.app.events.on_score_mode_change("single") if c else None)
